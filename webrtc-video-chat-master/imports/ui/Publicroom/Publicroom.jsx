...
export class Publicroom extends Component {
  ...
  socketConnection = () => {
    ...
    // this.connection.socketURL = 'https://384e809e.ngrok.io/'
    ...
    this.connection.onstream = (event) => {
      ...
      if (streams.length !== 0) {
        streams.forEach((res) => {
          if (res.streamid == event.streamid) {
    ...
    this.connection.DetectRTC.load(() => {
      ...
      if (!devices.length) {
        ...
        devices.forEach((device) => {
          if (device.label.match(/facing back/g)) {
      ...
      <React.Fragment>
        ...
        >
          ...
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <video autoPlay className="remote-video" id="remote-video3"></video>
            <video autoPlay className="remote-video" id="remote-video4"></video>
          </div>
